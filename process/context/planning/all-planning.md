---
description: Planning conventions and plan-shape calibration for Project-M: when to use the SIMPLE vs COMPLEX plan format, and example PRDs.
keywords: [plan, planning, prd, spec, roadmap, implementation plan, backlog, task folder, plan format]
---

# Planning Context

This file is the canonical planning context entrypoint for Project-M.
